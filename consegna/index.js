...
const domande = [
  {
    domanda: "Il tuo personaggio ha lavorato nel campo della scienza?",
    target: "scienziato",
  },
  {
    domanda: "Il tuo personaggio è un ingegnere?",
    target: "ingegnere",
  },
  {
    domanda: "Il tuo personaggio è noto per i suoi contributi in matematica?",
    target: "matematico",
  },
  {
    domanda: "Il tuo personaggio è conosciuto anche come artista?",
    target: "artista",
  },
  {
    domanda: "Il tuo personaggio ha lavorato nell'informatica?",
    target: "informatico",
  },
  {
    domanda: "Il tuo personaggio è ancora in vita?",
    target: "vivente",
  },
  {
    domanda: "Il tuo personaggio è una donna?",
    target: "donna",
  },
];
...
window.addEventListener("DOMContentLoaded", () => {
  ...
  alert(
    "Potrebbe verificarsi un breve ritardo nella visualizzazione delle immagini a causa del caricamento delle immagini stesse."
  );
